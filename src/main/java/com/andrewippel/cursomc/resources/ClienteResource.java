...
import com.andrewippel.cursomc.dto.ClienteDTO;
...
public class ClienteResource {
    ...
    public ResponseEntity<Page<ClienteDTO>> findPage(@RequestParam(value = "page", defaultValue = "0") Integer page,
        ...
        Page<Cliente> pg = service.findPage(page, linesPerPage, orderBy, direction);
        Page<ClienteDTO> pageDTO = pg.map(obj -> new ClienteDTO(obj));
